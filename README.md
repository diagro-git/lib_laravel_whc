...
<p align="center">
<img src="https://img.shields.io/badge/project-lib_laravel_whc-yellowgreen" alt="Diagro webhooks client library">
...
This library is used for backends that listen to webhook events from other backends.
